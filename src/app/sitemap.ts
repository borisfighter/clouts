...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/marketing`,     lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${base}/blog/ai-visibility-tools-compared`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
