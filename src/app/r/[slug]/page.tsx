      ...
      <div className="border-b border-white/[0.07] px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <a
              href={`https://twitter.com/intent/tweet?text=Check+out+${encodeURIComponent(brand.name)}%27s+AI+visibility+report&url=${encodeURIComponent(`https://www.clouts.com/r/${params.slug}`)}`}
