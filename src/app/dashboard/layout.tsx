...
import {
  ...
  Send, Bot, LineChart, Settings, Menu, ChevronDown, Zap
} from 'lucide-react'
    ...
    <div className="flex h-screen overflow-hidden bg-[#08090A] text-white">
      ...
      <aside className={cn(
        ...
        <div className="border-b border-white/[0.07] px-3 py-2.5">
          <button className="flex w-full items-center gap-2 rounded-lg bg-white/[0.04] px-3 py-2 text-xs font-medium text-white/70 hover:bg-white/[0.07] transition-colors">
            ...
            <span className="flex-1 text-left truncate">clouts.com</span>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-14 shrink-0 items-center gap-3 border-b border-white/[0.07] bg-[#08090A] px-4">
          ...
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-violet-500/20 text-violet-300 text-xs font-bold">K</div>
        </header>
