  ...
  if (done) return (
    <div className="flex min-h-screen items-center justify-center bg-[#08090A] px-4">
      <div className="w-full max-w-sm text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-400/10 border border-emerald-400/20">
          <Check size={24} className="text-emerald-400" />
        </div>
        <h1 className="mb-2 text-xl font-bold text-white">Check your email</h1>
        <p className="text-sm text-white/40">We sent a confirmation link to <strong className="text-white/70">{email}</strong>. Click it to activate your account.</p>
        <Link href="/auth/login" className="mt-6 inline-block text-sm text-violet-400 hover:text-violet-300">Back to login →</Link>
      </div>
    </div>
  )
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#08090A] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8">
          ...
          <p className="mb-6 text-sm text-white/40">Start monitoring your brand in AI engines</p>
